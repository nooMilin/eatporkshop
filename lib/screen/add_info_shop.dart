...
class _AddInfoShopState extends State<AddInfoShop> {
      ...
      child: RaisedButton.icon(
        ...
        onPressed: () {
          if (nameShop == null ||
            ...
            normalDialog(context, 'กรุณาเลือกรูปภาพ ค่ะ');
          }else{
            uploadImage();
          }
        },
  ...
  Future<Null> uploadImage()async{
    ...
    String url = '${MyConstant().domain}/eatporkshop/api/saveShop.php';
    ...
    try {
      ...
      await Dio().post(url, data: formData).then((value){
        ...
        urlImage = '/eatporkshop/api/Shop/$nameImage';
  ...
  Future<Null> editUserShop()async{
    ...
    String url = '${MyConstant().domain}/eatporkshop/api/editUserWhereId.php?isAdd=true&id=$id&NameShop=$nameShop&Address=$address&Phone=$phone&UrlPicture=$urlImage&Lat=$lat&Lng=$lng';

    await Dio().get(url).then((value){
      if (value.toString() == 'true') {
        Navigator.pop(context);
      } else {
        normalDialog(context, 'กรุณาลองใหม่ ไม่สามารถบันทึกได้ค่ะ');
      }
    });
  }
