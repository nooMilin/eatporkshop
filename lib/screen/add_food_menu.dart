...
class _AddFoodMenuState extends State<AddFoodMenu> {
  ...
  Future<Null> uploadFoodAndInsertData() async {
    String urlUpload = '${MyConstant().domain}/eatporkshop/api/saveFood.php';
    ...
    try {
      ...
      await Dio().post(urlUpload, data: formData).then((value) async {
        String urlPathImage = '/eatporkshop/api/Food/$nameFile';
        ...
        String urlInsertData =
            '${MyConstant().domain}/eatporkshop/api/addFood.php?isAdd=true&idShop=$idShop&NameFood=$nameFood&PathImage=$urlPathImage&Price=$price&Detail=$detail';
